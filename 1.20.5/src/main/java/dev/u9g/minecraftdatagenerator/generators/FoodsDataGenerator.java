...
public class FoodsDataGenerator implements IDataGenerator {
    ...
    public JsonArray generateDataJson() {
        ...
        Registry<ItemGroup> itemGroupRegistry = DGU.getWorld().getRegistryManager().get(RegistryKeys.ITEM_GROUP);
        itemGroupRegistry.get(ItemGroups.FOOD_AND_DRINK)
                .getDisplayStacks()
                .stream()
                .forEach(food -> resultsArray.add(generateFoodDescriptor(itemRegistry, food.getItem())));
        return resultsArray;
    }
}
